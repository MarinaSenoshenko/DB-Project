...
values (1, 'Иван', 'Иванович', 'Иванов', 1),
      (2, 'Елена', 'Ивановна', 'Петрова', 1),
      (3, 'Евгений', 'Анатольевич', 'Сидоров', 1),
      (4, 'Петр', 'Сергеевич', 'Матвеев', 2),
      (5, 'Валентина', 'Петровна', 'Владимирова', 2),
      (6, 'Дмитрий', 'Кириллович', 'Сеношенко', 2),
      (7, 'Михаил', 'Дмитриевич', 'Петров', 2),
      (8, 'Дмитрий', 'Евгеньевич', 'Иванов', 3),
      (9, 'Евгения', 'Антоновна', 'Матвеенко', 3),
      (10, 'Александра', 'Александровна', 'Александрова', 4),
      (11, 'Андрей', 'Андреевич', 'Полевой', 4),
      (12, 'Максим', 'Максимович', 'Максимов', 4),
      (13, 'Васисий', 'Васильевич', 'Васильев', 4),
      (14, 'Павел', 'Павлович', 'Павлов', 4),
      (15, 'Павел', 'Игоревич', 'Павленко', 5),
      (16, 'Нина', 'Никитична', 'Валеева', 5),
      (17, 'Юрий', 'Юрьевич', 'Петренко', 5),
      (18, 'Александр', 'Даниилович', 'Петров', 5),
      (19, 'Антонина', 'Павловна', 'Петрова', 1),
      (20, 'Диана', 'Петровна', 'Николаева', 1);
...
values (1, 'Иван', 'Иванович', 'Иванов'),
      (2, 'Борис', 'Викторович', 'Борисов'),
      (3, 'Виктория', 'Никитична', 'Ильина'),
      (4, 'Евгений', 'Игоревич', 'Петров'),
      (5, 'Сергей', 'Сергеевич', 'Сидоров'),
      (6, 'Елена', 'Ивановна', 'Белкина'),
      (7, 'Иван', 'Игоревич', 'Петров'),
      (8, 'Софья', 'Сергеевна', 'Павлова'),
      (9, 'Елена', 'Ивановна', 'Белкина'),
      (10, 'Максим', 'Петрович', 'Иванов');
